...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rootJsx = __webpack_require__(157);

	var _rootJsx2 = _interopRequireDefault(_rootJsx);

	main();

	function main() {
	  _react2['default'].render(_react2['default'].createElement(_rootJsx2['default'], null), document.getElementById('app'));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _radiokitApiJs = __webpack_require__(158);

	var _radiokitApiJs2 = _interopRequireDefault(_radiokitApiJs);

	var _layoutsLoading_layoutJsx = __webpack_require__(163);

	var _layoutsLoading_layoutJsx2 = _interopRequireDefault(_layoutsLoading_layoutJsx);

	var _layoutsAdmin_layoutJsx = __webpack_require__(165);

	var _layoutsAdmin_layoutJsx2 = _interopRequireDefault(_layoutsAdmin_layoutJsx);
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	    this.api = new _radiokitApiJs2['default']({ role: "Editor" });
	  },
	  ...
	  render: function render() {
	    if (this.state.currentEditor == null) {
	      return _react2['default'].createElement(_layoutsLoading_layoutJsx2['default'], null);
	    } else {
	      return _react2['default'].createElement(_layoutsAdmin_layoutJsx2['default'], { currentEditor: this.state.currentEditor, api: this.api });
	    }
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dataJs = __webpack_require__(159);

	var _dataJs2 = _interopRequireDefault(_dataJs);

	var _authOauth2Js = __webpack_require__(162);

	var _authOauth2Js2 = _interopRequireDefault(_authOauth2Js);

	var ĄPI = (function () {
	  function ĄPI() {
	    var options = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];

	    _classCallCheck(this, ĄPI);

	    if (!options.hasOwnProperty("auth") && options.hasOwnProperty("role")) {
	      this.__auth = new _authOauth2Js2["default"](options.role).authenticate();
	    }
	  }
	  ...
	  _createClass(ĄPI, [{
	    key: "data",
	    value: function data() {
	      return new _dataJs2["default"](this.__auth);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dataAppJs = __webpack_require__(160);

	var _dataAppJs2 = _interopRequireDefault(_dataAppJs);
	...
	var Data = (function () {
	  ...
	  _createClass(Data, [{
	    ...
	    value: function app(appName) {
	      return new _dataAppJs2["default"](this.__auth, appName);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _modelJs = __webpack_require__(161);

	var _modelJs2 = _interopRequireDefault(_modelJs);

	var DataApp = (function () {
	  function DataApp(auth, appName) {
	    _classCallCheck(this, DataApp);

	    this.__auth = auth;
	    this.__appName = appName;
	  }

	  _createClass(DataApp, [{
	    key: "model",
	    value: function model(modelName) {
	      return new _modelJs2["default"](this.__auth, this.__appName, modelName);
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	var DataModel = (function () {
	  function DataModel(auth, appName, modelName) {
	  ...
	  _createClass(OAuth2, [{
	    ...
	    value: function authenticate() {
	      if (window.location.hash !== "") {
	        var hashAsDict = window.location.hash.substr(1).split("&").reduce(function (previous, current) {
	          var splitted = current.split("=", 2);
	    ...
	    key: "cleanupLocationHash",
	    value: function cleanupLocationHash(hashAsDict, keyToDelete) {
	      delete hashAsDict[keyToDelete];
	      window.location.hash = Object.keys(hashAsDict).map(function (x) {
	        return encodeURIComponent(x) + "=" + encodeURIComponent(hashAsDict[x]);
	      }).join("&");
	    }
	  }, {
	    key: "redirectToAuthGateway",
	    value: function redirectToAuthGateway() {
	      var redirectUrl = window.location.origin + window.location.pathname + window.location.search;
	      var authGatewayUrl = this.baseUrl + "/oauth2/authorize/" + encodeURIComponent(this.role) + "?response_type=token&client_id=" + encodeURIComponent(this.clientId) + "&redirect_uri=" + encodeURIComponent(redirectUrl);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _spinJs = __webpack_require__(164);

	var _spinJs2 = _interopRequireDefault(_spinJs);

	exports['default'] = _react2['default'].createClass({
	  displayName: 'loading_layout',
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    this.spinner = new _spinJs2['default'](opts).spin(_react2['default'].findDOMNode(this.refs.spinner));
	  },
	  ...
	  render: function render() {
	    return _react2['default'].createElement('div', { ref: 'spinner' });
	  }
	});
	module.exports = exports['default'];
