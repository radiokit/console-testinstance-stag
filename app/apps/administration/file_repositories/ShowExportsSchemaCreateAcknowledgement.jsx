        ...
        <div className="row style-accent">
          <div className="col-md-12 text-center">
            <div className="btn-group btn-group-justified small-padding" role="group">
              <a className="btn btn-default-bright" href={`${window.data.options.apps.vault.baseUrl}/api/connector/v1.0/mixcloud/ask?record_repository_id=${encodeURIComponent(this.props.record.get("id"))}`}>
