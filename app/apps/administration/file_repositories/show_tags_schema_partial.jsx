      ...
      <div className="ShowTagsSchemaPartial">
        <ul className="list">
          { _.sortBy(category.tag_items,'name').map((tag) => {
            const onDeleteTagListener = () => this.showDeleteTagModal.bind(tag);
            const onEditTagListener = () => this.showEditTagModal.bind(tag);
            return (
    ...
    return (
      <div className="ShowTagsSchemaPartial">
        ...
        { this.state.categories.size > 0 && _.sortBy(this.state.categories.toJS(),'name').map((category) => {
            ...
            const onDeleteCategoryListener = () => this.showDeleteCategoryModal.bind(category);
            const onEditCategoryListener = () => this.showEditCategoryModal.bind(category);
